        ...
        <div className="container-custom">
          <div className="flex items-center justify-between h-18 py-4">
            ...
            <a href="#" className="flex items-center gap-2 group">
              <div className="w-10 h-10 rounded-xl bg-gradient-fabric flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-fabric-700/30 group-hover:shadow-fabric-700/50 transition-shadow">
                SR
              </div>
              <span
                className={cn(
            ...
            <div className="hidden lg:flex items-center gap-1">
              {navLinks.map((link) => (
                <a
                  ...
                  href={link.href}
                  className={cn(
                    "px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-white/10",
                    isScrolled
                      ? "text-slate-600 hover:text-fabric-700 hover:bg-fabric-50"
                ...
                <div className="flex flex-col gap-2">
                  {navLinks.map((link) => (
                    <a
                      ...
                      href={link.href}
                      onClick={() => setIsMobileMenuOpen(false)}
                      className="px-4 py-3 rounded-xl text-slate-700 font-medium hover:bg-fabric-50 hover:text-fabric-700 transition-colors"
                    >
                      {link.name}
                    </a>
                  ))}
