      ...
      <div className="shell">
        <div className="grid gap-x-12 gap-y-14 pb-16 pt-14 md:grid-cols-12 lg:pb-24 lg:pt-24">
          <div className="md:col-span-12 lg:col-span-7">
            ...
            <motion.h1
              {...rise(0.08)}
              className="mt-8 text-display-lg font-normal"
              style={{ textWrap: "balance" }}
            >
              Data platforms that
              <br className="hidden sm:block" />{" "}
              <em className="font-normal italic text-accent">hold up</em> in production.
            </motion.h1>
        ...
        >
          {stats.map((stat, i) => (
            ...
            >
              ...
              <dd>
                <span className="nums font-serif text-4xl leading-none sm:text-5xl">{stat.value}</span>
