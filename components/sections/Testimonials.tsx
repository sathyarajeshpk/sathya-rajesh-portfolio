...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="py-24 lg:py-32 bg-slate-950 relative overflow-hidden">
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-fabric-600/10 rounded-full blur-[128px]" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-fabric-400/5 rounded-full blur-[128px]" />
      ...
      <div className="container-custom relative">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.span
            ...
            className="inline-block px-4 py-1.5 rounded-full glass text-slate-300 text-sm font-semibold mb-6"
          >
            Testimonials
          </motion.span>
          <motion.h2
        ...
        <div ref={ref} className="grid md:grid-cols-3 gap-6">
          {testimonials.map((t, index) => (
            <motion.div
              ...
              className="glass rounded-2xl p-8 relative group hover:bg-white/15 transition-all duration-300"
            >
              <Quote className="w-10 h-10 text-fabric-500/30 mb-4" />
