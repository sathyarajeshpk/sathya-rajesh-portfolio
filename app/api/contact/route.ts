...
async function sendEmail(fields: Record<FieldName, string>) {
  ...
  const row = (label: string, value: string) =>
    `<tr><td style="padding:6px 16px 6px 0;color:#4c525a;font:14px system-ui">${label}</td>` +
  ...
  const html = `
    <div style="font:14px system-ui;color:#13151A;max-width:640px">
      <p style="font:14px system-ui;color:#4c525a">New enquiry from your website</p>
      <h2 style="font:700 22px system-ui;margin:4px 0 20px">${escapeHtml(fields.name)}${
      ...
      <p style="font:700 15px system-ui;margin-bottom:4px">What they need</p>
